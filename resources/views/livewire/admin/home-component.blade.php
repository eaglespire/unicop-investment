<div wire:key="admin.home-component">
    @if(!empty($data))
        <div class="row">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-4">
                                <div class="mt-4 mt-sm-0">
                                    <img src="/back/assets/images/setup-analytics-amico.svg" class="img-fluid" alt="">
                                </div>
                            </div>
                        </div>
                    </div> <!-- end card-body-->
                        ...
                        <div data-simplebar style="max-height: 339px;">
                            <div class="table-responsive">
                                <table class="table table-borderless table-centered table-nowrap">
                                    <tbody>
                                    <tr>
                                        <td style="width: 20px;"><img src="/back/assets/images/users/avatar-4.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="/back/assets/images/users/avatar-5.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="/back/assets/images/users/avatar-6.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="/back/assets/images/users/avatar-7.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="/back/assets/images/users/avatar-8.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="/back/assets/images/users/avatar-2.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                            <h6 class="font-size-15 mb-1 fw-normal">Marie Kim</h6>
                                    ...
                                    <tr>
                                        <td><img src="/back/assets/images/users/avatar-1.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                            <h6 class="font-size-15 mb-1 fw-normal">Sonya Henshaw</h6>
