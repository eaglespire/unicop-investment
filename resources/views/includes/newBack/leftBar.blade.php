<div class="left-side-menu">
    <div class="media user-profile mt-2 mb-2">
        ...
        <div class="media-body">
            <h6 class="pro-user-name mt-0 mb-0">{{ \App\Helpers::buildFullName(auth()->id()) }}</h6>
        ...
        <div class="dropdown align-self-center profile-dropdown-menu">
            ...
            <div class="dropdown-menu profile-dropdown">
                ...
                <a onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" href="{{ route('logout') }}" class="dropdown-item notify-item">
            ...
            <ul class="metismenu" id="menu-bar">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li>
                            <a href="{{ route('admin.read-users-component') }}">All Users</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.user-status-component') }}">User Status</a>
                        </li>
                    </ul>
                </li>
                <li>
