...
<script src="{{ asset('back/assets/libs/waypoints/lib/jquery.waypoints.min.js') }}"></script>
<script src="{{ asset('back/assets/libs/jquery.counterup/jquery.counterup.min.js') }}"></script>
