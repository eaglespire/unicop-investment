        ...
        <div class="card h-100">
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h5 class="mt-3 mb-1">{{ $firstname }} {{ $lastname }}</h5>
                ...
                <div class="text-muted">
                    ...
                    <p>
                       <span class="text-primary">{{ $firstname }} {{ $lastname }} {{ $middlename }}</span> lives at {{ $street }}, with zip code {{ $postal }} , {{ $city }} {{ $state }} {{ $country }}
                    </p>
                    <div class="table-responsive mt-4">
                        <div>
                            <p class="mb-1">First Name :</p>
                            <h5 class="font-size-16">{{ $firstname }}</h5>
                        </div>
                        <div class="mt-4">
                            <p class="mb-1">Middle Name :</p>
                            <h5 class="font-size-16">{{ $middlename }}</h5>
                        </div>
                        <div class="mt-4">
                            <p class="mb-1">Last Name :</p>
                            <h5 class="font-size-16">{{ $lastname }}</h5>
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="mt-4">
                            ...
                            <h5 class="font-size-16">{{ $password_text }}</h5>
                        </div>
